...
class Control {
  ...
  setOptinDataEnabled(isEnabled) {
    AccControl.setOptinDataEnabled(isEnabled);
  }

  setOptinGeolocEnabled(isEnabled) {
    AccControl.setOptinGeolocEnabled(isEnabled);
  }

  isOptinDataEnabled() {
    return AccControl.isOptinDataEnabled();
  }

  isOptinGeolocEnabled() {
    return AccControl.isOptinGeolocEnabled();
  }
